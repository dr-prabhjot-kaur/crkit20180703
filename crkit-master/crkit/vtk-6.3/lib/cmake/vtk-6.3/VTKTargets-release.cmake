...
set_target_properties(vtkGUISupportQt PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libvtkGUISupportQt-6.3.so.1"
  IMPORTED_SONAME_RELEASE "libvtkGUISupportQt-6.3.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkGUISupportQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkGUISupportQt "${_IMPORT_PREFIX}/lib/libvtkGUISupportQt-6.3.so.1" )
...
set_target_properties(vtkGUISupportQtOpenGL PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libvtkGUISupportQtOpenGL-6.3.so.1"
  IMPORTED_SONAME_RELEASE "libvtkGUISupportQtOpenGL-6.3.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkGUISupportQtOpenGL )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkGUISupportQtOpenGL "${_IMPORT_PREFIX}/lib/libvtkGUISupportQtOpenGL-6.3.so.1" )
...
set_target_properties(vtkRenderingQt PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libvtkRenderingQt-6.3.so.1"
  IMPORTED_SONAME_RELEASE "libvtkRenderingQt-6.3.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkRenderingQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkRenderingQt "${_IMPORT_PREFIX}/lib/libvtkRenderingQt-6.3.so.1" )
